...
public class C04_MethodOverloading {
    ...
    public static void topla(int a , int b){// "topla int int"a signature denir
    ...
    public static void topla(short  c , int d){// "topla int int"a signature denir
        System.out.println("iki tamsayinin toplami : " + (c+d));
    }
}
