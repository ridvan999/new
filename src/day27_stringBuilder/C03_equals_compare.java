...
public class C03_equals_compare {
    public static void main(String[] args) {
        ...
        StringBuilder sb7= new StringBuilder("Kara");
        System.out.println(sb1.compareTo(sb3)); // 2//Javanın Jsi Havanın H sinden 2 sıra yukarda
        System.out.println(sb1.compareTo(sb4)); // 2
        System.out.println(sb3.compareTo(sb4)); // 4
        System.out.println(sb4.compareTo(sb3)); // -4 r harfi v harfinden 4 şağıdadır
        System.out.println(sb7.compareTo(sb3));//3
        /*
