    ...
    public static void main(String[] args) {
         ...
         */
            ...
            for (int i = 0; i < arr.length; i++) {
                yeniArr[i] = arr[i];// eski arrnin 1,2 ve 3 üncü elementlleri yeni arrye atandı
                                     //fakat yeni arrnin 4. elementi henüz default değerde
            }                       // yeniArr [4,5,6,0]
            yeniArr[yeniArr.length - 1] = eklenecekElement; // [4,5,6,10]
                                                            //yeni arrnin son indeksindeki değere eklenecek elementin değerini atadık
