...
public class C06_PeriodOfTime {
    public static void main(String[] args) {
        ...
        System.out.println("Yas : "+Period.between(dogumTarihi,bugun).getDays()+" gün "
                +Period.between(dogumTarihi,bugun).getMonths()+" ay "
                +Period.between(dogumTarihi,bugun).getYears()+" yıl");
    }
}
