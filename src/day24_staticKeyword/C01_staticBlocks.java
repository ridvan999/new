...
public class C01_staticBlocks {{ System.out.println("EN ÜSTTEKİ STATİC OLMAYAN calisti."); }
    C01_staticBlocks(){
    ...
    {
        System.out.println("en alttaki statik olmayan blok çalıştı");
    }
}
                    /* BENİM ANLADIĞIM
                        -ÖNCE STATİC BLOKLAR YUKARDAN AŞAĞI ÇALIŞIR.
                        -SONRA MAİN METHODDA YUKARDAN AŞAĞI GİDER.
                        -SONRA STATİC OLMAYAN BLOKLARA GEÇER
                        -SONRA CONSTRUCTOR
