...
public class C05_indexOf_notUnderstand {
    public static void main(String[] args) {
        ...
        System.out.println(str.indexOf("cok")); // 5
                                                //kelimenin ilk harfindeki indexi alır

        System.out.println(str.indexOf("cok", 6)); // 13
                                                                // 6. indexten sonra gördüğü ilk "çok" ifadesini buldu
                                                                //daha sonra o ifadenin tam cümledeki inexine göre sonuç verdi
                                                                //yani cümlede 2. defa geçen çok ifadesinin indexini gösterdi


        System.out.println(str.indexOf("cok", 5)); // 5
                                                                //burda 5. indexte çok'u yakaladığı için indexi de ilk çokun indexi oldu
